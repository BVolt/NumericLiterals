class OctIntDFA:
    ...
    def __init__(self):
        self.transition = { # transition function for all states
            ...
            "q3": lambda c: "q5" if c in self.octDigits else ("q4" if c=="_" else "q7"),
            "q4": lambda c: "q5" if c in self.octDigits else "q7",
            "q5": lambda c: "q5" if c in self.octDigits else ("q6" if c=="_" else "q7"),
            "q6": lambda c: "q5" if c in self.octDigits else "q7",
            "q7": lambda c: "q7"
        }
