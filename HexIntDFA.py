class HexIntDFA:
    ...
    def __init__(self):
        self.transition = { # transition function for all states
            ...
            "q3": lambda c: "q4" if c in self.hexDigits else ("q5" if c=="_" else "q7"),
            "q4": lambda c: "q4" if c in self.hexDigits else ("q6" if c=="_" else "q7"),
            "q5": lambda c: "q4" if c in self.hexDigits else "q7",
            "q6": lambda c: "q4" if c in self.hexDigits else "q7",
            "q7": lambda c: "q7"
        }
